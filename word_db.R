...
pos.words = scan('C:/Users/GKS/Documents/pos.txt', what='character', comment.char=';') #Make sure you edit the location
neg.words = scan('C:/Users/GKS/Documents/Negative-Words.txt', what='character', comment.char=';')
